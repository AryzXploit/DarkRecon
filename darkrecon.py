...
# Direktori untuk menyimpan user data
...
def run_command(command):
    try:
        ...
        return filtered_output if filtered_output else "⚠️ [bold yellow]No relevant output received from the command![/bold yellow]"
